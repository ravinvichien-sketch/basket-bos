-- ============================================================
-- Basket Bos — SETUP ALL (ล้างกระดาน + ติดตั้งทุก migration ในครั้งเดียว)
-- วางทั้งไฟล์นี้ใน Supabase SQL Editor แล้วกด Run ครั้งเดียว
-- คำเตือน: ลบข้อมูลเดิมของแอปทั้งหมด (ใช้ตอนติดตั้งครั้งแรกเท่านั้น)
-- ============================================================

-- 0) ล้างของเก่าทั้งหมด
...
drop policy if exists "videos_write_admin" on storage.objects;
